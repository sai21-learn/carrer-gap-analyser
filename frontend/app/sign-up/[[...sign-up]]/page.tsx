    ...
    <div className="flex min-h-screen items-center justify-center bg-black relative overflow-hidden font-tech">
      ...
      <div className="relative z-10 w-full max-w-md p-4">
        <div className="mb-8 text-center space-y-2">
           <h2 className="text-[10px] font-bold uppercase tracking-[0.4em] text-white/40">New_Entity</h2>
           <h1 className="text-2xl font-bold uppercase tracking-tight text-white">System_Registration</h1>
        </div>
